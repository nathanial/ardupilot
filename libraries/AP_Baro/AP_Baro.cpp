...
#if __has_include("AP_Baro_BMP085.h")
...
#if __has_include("AP_Baro_BMP280.h")
...
#if __has_include("AP_Baro_BMP388.h")
...
#if __has_include("AP_Baro_BMP581.h")
#include "AP_Baro_BMP581.h"
#else
#undef AP_BARO_BMP581_ENABLED
#define AP_BARO_BMP581_ENABLED 0
#endif

#if __has_include("AP_Baro_SPL06.h")
...
#if __has_include("AP_Baro_KellerLD.h")
...
#if __has_include("AP_Baro_LPS2XH.h")
...
#if __has_include("AP_Baro_FBM320.h")
...
#if __has_include("AP_Baro_DPS280.h")
...
#if __has_include("AP_Baro_ICP201XX.h")
...
#if __has_include("AP_Baro_AUAV.h")
#include "AP_Baro_AUAV.h"
#else
#undef AP_BARO_AUAV_ENABLED
...
// Simple underwater atmospheric model for SITL submarine simulation
